...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['Contribute to Open Source'];
    progressListArray = ['Improve existing skills'];
    completeListArray = ['Do Exercise', 'Read a book'];
    onHoldListArray = ['Sit back and relax', 'Listen to music'];
  }
}
